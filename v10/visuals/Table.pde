...
//    }
//    else{
//      print("Pick a valid card or else you will be punched by the extremely non violent peace advocates");
//      go();
//    }
//  }
...
//    print(current.getName() + " placed a " + top + "\n--");
//    current.uno();
//    if (current.wonOrNot()) {
//      return;
//    }
